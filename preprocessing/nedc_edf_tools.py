...
# files: $(NEDC_NFC)/class/python/nedc_edf_tools/nedc_edf_tools.py
#                                                                              
# revision history:                                                            
#
...
class Edf:
    ...
    #
    # returns: the header of the argument file
    #
